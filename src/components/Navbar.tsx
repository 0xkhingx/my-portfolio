...
export default function Navbar() {
  ...
  isCollapsed
    ...
    : 'gap-2 px-3 sm:gap-3 sm:px-4 lg:gap-4 lg:px-6 w-auto max-w-full'
}`}
      >
        <motion.button
          layout
        ...
        <ul className="list-none flex gap-2 lg:gap-3 items-center m-0 p-0 min-w-0">
          ...
          {sections
            ...
            >
              <a
                ...
                className={`relative inline-flex items-center justify-center px-2.5 lg:px-3 py-3 rounded-full text-[14px] font-semibold uppercase tracking-wide whitespace-nowrap leading-none no-underline transition-colors duration-300 will-change-transform ${
                  activeSection === s.id
                    ? 'text-island-fg'
