...
export default function Navbar() {
  ...
  isCollapsed
    ? 'gap-5 px-4 sm:gap-3 sm:px-6 w-auto min-w-[180px] sm:min-w-[200px]'
    : 'gap-5 px-4 sm:gap-3 sm:px-6 md:gap-10 md:px-12 w-auto min-w-[75vw] md:min-w-[500px] max-w-[900px]'
}`}
      >
